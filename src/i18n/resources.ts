  ...
  en: {
    translation: {
      ...
      stats: {
        ...
        syncIssues_one: '{{count}} Skill has sync issues',
        syncIssues_other: '{{count}} Skills have sync issues',
      ...
      deviceSync: {
        ...
        otherDevicesUpToDate: 'Other devices are up to date',
        devices: 'Devices',
        device: 'Device',
        deviceStatus: 'Status',
        ...
        autoCheckHelp: 'Only checks whether changes exist; it does not modify files.',
        autoSync: 'Sync automatically',
        autoSyncHelp: 'Off by default. When enabled, pending changes sync when the app starts.',
  ...
  zh: {
    translation: {
      ...
      stats: {
        ...
        syncIssues: '{{count}} 个 Skills 同步异常',
      ...
      deviceSync: {
        ...
        autoCheck: '自动检查',
        autoCheckHelp: '只检查有没有变化，不会修改文件。',
        autoSync: '自动同步',
        autoSyncHelp: '默认关闭；开启后会在应用启动时同步待处理变化。',
        whatSyncs: '将同步什么？',
