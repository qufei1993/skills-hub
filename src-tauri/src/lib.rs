...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::export_skills_with_presentation,
            ...
            commands::get_skill_profiles,
            commands::upsert_skill_profile,
            commands::delete_skill_profile,
            commands::get_profile_draft_status,
            commands::save_profile_draft_config,
            commands::set_profile_draft_api_key,
            commands::list_profile_draft_models,
            commands::test_profile_draft_connection,
            commands::autofill_skill_profile,
